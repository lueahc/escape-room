...
describe('RecordController', () => {
    ...
    describe('GET /record', () => {
        ...
        it('recordService.getAllRecordsAndReviews를 호출한다.', async () => {
            ...
            jest.spyOn(recordService, 'getAllRecordsAndReviews').mockResolvedValue(expectedResult);
            await recordController.getAllRecordsAndReviews(userId, visibility);
            expect(recordService.getAllRecordsAndReviews).toHaveBeenCalledWith(userId, visibility);
        });
    });
    ...
    describe('GET /record/{recordId}', () => {
        ...
        it('recordService.getTaggedUsers를 호출한다.', async () => {
            ...
            jest.spyOn(recordService, 'getTaggedUsers').mockResolvedValue(expectedResult);
            await recordController.getTaggedUsers(userId, recordId);
            expect(recordService.getTaggedUsers).toHaveBeenCalledWith(userId, recordId);
        });
    });
    ...
    describe('POST /record', () => {
        ...
        it('recordService.createRecord를 호출한다.', async () => {
            ...
            jest.spyOn(recordService, 'createRecord').mockResolvedValue(expectedResult);
            const result = await recordController.createRecord(userId, createRecordRequestDto, file);
            expect(result).toEqual(expectedResult);
            expect(recordService.createRecord).toHaveBeenCalledWith(userId, createRecordRequestDto, file);
        });
    });
    ...
    describe('PATCH /record/{recordId}', () => {
        ...
        it('recordService.updateRecord를 호출한다.', async () => {
            ...
            jest.spyOn(recordService, 'updateRecord').mockResolvedValue(expectedResult);
            const result = await recordController.updateRecord(userId, recordId, updateRecordRequestDto, file);
            expect(result).toEqual(expectedResult);
            expect(recordService.updateRecord).toHaveBeenCalledWith(userId, recordId, updateRecordRequestDto, file);
        });
    });
    ...
    describe('PATCH /record/{recordId}/visibility', () => {
        ...
        it('recordService.changeRecordVisibility를 호출한다.', async () => {
            const userId = 1;
            const recordId = 1;
            jest.spyOn(recordService, 'changeRecordVisibility').mockImplementation(async () => { });
            await recordController.changeRecordVisibility(userId, recordId);
            expect(recordService.changeRecordVisibility).toHaveBeenCalledWith(userId, recordId);
        });
    });
    ...
    describe('DELETE /record/{recordId}', () => {
        ...
        it('recordService.deleteRecord를 호출한다.', async () => {
            const userId = 1;
            const recordId = 1;
            jest.spyOn(recordService, 'deleteRecord').mockImplementation(async () => { });
